      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-[72ch] mx-auto text-center">
          ...
          >
            ...
            <span className="grad-ithingy italic font-bold">
              {t?.hero?.title2 || "IThingy"}
            </span>
            <motion.span
          ...
          >
            <Button
              ...
              asChild
            >
              <a href="#contact">{t?.hero?.btnPrimary || "Get started"}</a>
            </Button>
            <Button
              size="lg"
              variant="outline"
              ...
              asChild
            >
              <a href="#cases">{t?.hero?.btnSecondary || "Learn more"}</a>
            </Button>
          </motion.div>
        </div>
      </div>
