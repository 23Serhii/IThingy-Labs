            ...
            <div className="container mx-auto px-3 sm:px-4 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <p className="mt-3 sm:mt-4 text-[13px] sm:text-sm text-muted-foreground max-w-xl sm:max-w-2xl mx-auto">
                        We use AI as a developer tool — accelerating delivery while keeping data ownership and privacy
                        intact.
                    </p>
                </motion.div>
            ...
            "
                    >
                        ...
                        <p className="text-[13px] sm:text-sm text-muted-foreground mb-3 sm:mb-4 leading-relaxed">
                            A fixed-scope, 4-week engagement to prove rapid value: secure PoC, prioritized roadmap, and
                            a handoff-ready
                  ...
                  Secure PoC environment (isolated container + dedicated AI endpoint + audit logs)
                        ...
                        <Button asChild size="lg" className="w-full">
                            <Link href="/#contact">Start a 4-week Secure Sprint</Link>
                        </Button>
                    ...
                    >
                        ...
                        <p className="text-[13px] sm:text-sm text-muted-foreground mb-3 sm:mb-4 leading-relaxed">
                            Controlled AI assistance shortens prototyping and development loops so your product ships
                            sooner — without
                    ...
                    >
                        ...
                        <p className="text-[13px] sm:text-sm text-muted-foreground mb-3 sm:mb-4 leading-relaxed">
                            Projects run in isolated client containers with dedicated AI endpoints. Prompts and outputs
                            are not retained unless
                        ...
                        <p className="text-[13px] sm:text-sm text-muted-foreground">Compliance-ready: GDPR / ISO27001
                            posture available.</p>
                    </motion.div>
                </div>
                ...
                >
                    <p className="leading-relaxed">
                        Want to validate faster with low risk? Book the Secure Sprint — we set up an isolated PoC and
                        show measurable outcomes within 4 weeks.
                    </p>
                </motion.div>
            </div>
        </section>
